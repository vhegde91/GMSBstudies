...
do
    echo "----------------------------------"
    echo $sample
    filesFound=`eos root://cmseos.fnal.gov ls -l /store/user/vhegde/GMSBstudies/signalRegionSkim/a676087f1707bdbd3a5158edb058d445fc625d27/ | grep $sample | wc -l`
    filesSubmitted=`ls signalRegionSkim_$sample*.jdl | wc -l`
